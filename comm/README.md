...
3. Descargue archivo de nginx.conf del NGINX y editedo para reemplazar los siguientes elementos:
...
4. Descargue los archivos de configuración con las recomendaciones de seguridad:  options-ssl-nginx.conf y ssl-dhparams.pem
